...
const subscribe = async () => {
  try {
    ...
    formData.append("CommencementDate", new Date(document.getElementById("CommencementDate").value).toISOString());
    ...
    formData.append("EmpolyeeTitle", document.getElementById("EmpolyeeTitle").value);
      let response = await fetch('http://Schooll.somee.com/api/Home/AddEmployee', {
      method: 'POST',
      body: formData,
      });
